...
const features = [
  ...
  },
  {
    ...
    description:
      "See both raw Markdown and rendered preview side-by-side for quick verification.",
    color: "text-primary",
    bgColor: "bg-primary/10",
  },
];
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 md:mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Purpose-built for developers, researchers, and AI enthusiasts who
            need clean, structured content from any web source.
          </p>
        </div>
